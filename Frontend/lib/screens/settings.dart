...
import 'orders_screen.dart'; // Import the new orders screen
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: BottomNavigation(
          ...
          onTap: (index) {
            if (index == 3) return; // Already on the Settings screen
            Navigator.pushNamed(context, index == 0 ? '/home' : '/otherScreen');
          },
        ),
      ),
    );
